...
public class InmarsatHeader implements InmarsatMessage {
	...
	public String toString() {
		return "InmarsatHeader [getheaderType()=" + getheaderType() + ", getHeaderLength()=" + getHeaderLength()
				+ ", getMsgRefNr()=" + getMsgRefNr() + ", getDataPresentation()=" + getDataPresentation()
				+ ", getSatId()=" + getSatId() + ", getLesId()=" + getLesId() + ", getMessageLength()="
				+ getMessageLength() + ", getStoredTime()=" + getStoredTime() + ", getDnid()=" + getDnid()
